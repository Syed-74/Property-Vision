...
const Properties = () => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      payload.append(
        "physicalDetails",
        JSON.stringify(formData.physicalDetails),
      );
      payload.append(
        "financialDetails",
        JSON.stringify(formData.financialDetails),
      );

      if (isEdit) {
        await axios.put(`${API_URL}/${selectedProperty._id}`, payload, {
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateField(null, "propertyName", e.target.value)
                          }
                        />
                      </div>
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            updateField(null, "propertyType", e.target.value)
                          }
                        >
                          {propertyTypes.map((t) => (
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            updateField(null, "ownershipType", e.target.value)
                          }
                        >
                          <option>Owned</option>
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            updateField(null, "description", e.target.value)
                          }
                        />
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            updateField("location", "pincode", e.target.value)
                          }
                        />
                      </div>
                    </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-center gap-2 sm:col-span-2">
                          <input
                            type="checkbox"
                            checked={
                              formData.physicalDetails.parkingAvailable || false
                            }
                            onChange={(e) =>
                              updateField(
                                "physicalDetails",
                ...
                {step === 5 && (
                  <section className="space-y-6">
                    ...
                    <div className="bg-gray-50 border rounded-lg p-4 grid sm:grid-cols-2 gap-3">
                      <p>
                        <b>Name:</b> {formData.propertyName}
                      </p>
                      <p>
                        <b>Type:</b> {formData.propertyType}
                      </p>
                      <p>
                        <b>City:</b> {formData.location.city}
                      </p>
                      <p>
                        <b>Total Area:</b> {formData.physicalDetails.totalArea}
                      </p>
                      <p>
                        <b>Purchase Price:</b>{" "}
                        {formData.financialDetails.purchasePrice}
                      </p>
                    </div>
                  </section>
                )}
              ...
              <div className="p-6 max-h-[80vh] overflow-y-auto space-y-8 text-sm">
                ...
                <section className="bg-gray-50 rounded-xl p-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <Info
                      label="Ownership"
                      value={selectedProperty.ownershipType}
                    />
                    <Info
                      label="Description"
                ...
                <section className="bg-gray-50 rounded-xl p-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <Info
                      label="State"
                      value={selectedProperty.location?.state}
                    />
                    <Info
                      label="City"
                    ...
                    <Info
                      label="Area"
                      value={selectedProperty.location?.area || "—"}
                    />
                    <Info
                      label="Address"
                    ...
                    <Info
                      label="Landmark"
                      value={selectedProperty.location?.landmark || "—"}
                    />
                    <Info
                      label="Pincode"
                      value={selectedProperty.location?.pincode || "—"}
                    />
                ...
                <section className="bg-gray-50 rounded-xl p-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <Info
                      label="Total Area"
                      value={selectedProperty.physicalDetails?.totalArea}
                    />
                    <Info
                      label="Built-up Area"
                      value={
                        selectedProperty.physicalDetails?.builtUpArea || "—"
                      }
                    />
                    <Info
                      label="Floors"
                      value={
                        selectedProperty.physicalDetails?.numberOfFloors || "—"
                      }
                    />
                    <Info
                      label="Year Built"
                      value={selectedProperty.physicalDetails?.yearBuilt || "—"}
                    />
                    <Info
                      label="Parking"
                      value={
                        selectedProperty.physicalDetails?.parkingAvailable
                          ? "Yes"
                          : "No"
                      }
                    />
                    <Info
                      label="Water Supply"
                      value={
                        selectedProperty.physicalDetails?.waterSupplyType || "—"
                      }
                    />
                    <Info
                      label="Electricity Meter"
                      value={
                        selectedProperty.physicalDetails
                ...
                <section className="bg-gray-50 rounded-xl p-5">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <Info
                      ...
                      value={selectedProperty.financialDetails?.purchasePrice}
                    />
                    <Info
                      label="Market Value"
                      value={
                        selectedProperty.financialDetails?.currentMarketValue ||
                        "—"
                      }
                    />
                    <Info
                      label="Property Tax"
                      value={
                        selectedProperty.financialDetails?.propertyTaxAmount ||
                        "—"
                      }
                    />
                    <Info
                      ...
                      value={
                        selectedProperty.financialDetails?.maintenanceCost ||
                        "—"
                      }
                    />
                    <Info
                      label="Currency"
                      value={selectedProperty.financialDetails?.currency}
                    />
                  </div>
                </section>
