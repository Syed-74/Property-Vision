        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-4xl rounded-xl shadow-xl">
            ...
            <div className="p-6 grid sm:grid-cols-2 gap-4">
              ...
              <input className="input bg-gray-100" value={tenantForm.tenantCode} disabled />
              ...
              <input className="input" placeholder="Rent Amount"
                value={tenantForm.rentAmount}
                onChange={e => setTenantForm({ ...tenantForm, rentAmount: e.target.value })}
              />

              <input className="input" placeholder="Maintenance Amount"
                value={tenantForm.maintenanceAmount}
                onChange={e => setTenantForm({ ...tenantForm, maintenanceAmount: e.target.value })}
              />

              <select className="input" value={tenantForm.propertyId}
              ...
              <select className="input" value={tenantForm.floorId}
                onChange={e => setTenantForm({ ...tenantForm, floorId: e.target.value })}
              >
              ...
              <select className="input" value={tenantForm.unitId}
